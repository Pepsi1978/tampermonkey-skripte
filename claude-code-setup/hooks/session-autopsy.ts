...
const RULE_SUGGESTIONS: Record<CorrectionType, string> = {
  ...
  wrong_file:
    "Datei-Pfade explizit bestätigen bevor Änderungen gemacht werden",
  wrong_approach:
    "Lösungsansatz kurz erklären bevor mit der Implementierung begonnen wird",
  language_issue:
    "Kommunikation auf Deutsch, Code/Commits auf Englisch",
  factual_error:
    "Faktische Aussagen mit Web-Recherche verifizieren",
  other:
    "Öfter beim Benutzer rückfragen ob der Ansatz korrekt ist",
};
